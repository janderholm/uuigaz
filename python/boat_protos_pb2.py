...
_BASEMESSAGE = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='fire', full_name='messages.BaseMessage.fire', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='report', full_name='messages.BaseMessage.report', index=2,
