...
/**
 * Wrapper class for a board message.
 *
 * This is not an actual board message but rather a wrapping class
 * with a few game related methods. Not a subclass of BoatProtos.Board
 * because subclassing autogenerated protobuf classes is evil.
 *
 * */
public class Board
{
    ...
    /**
     * Build and return a Board message
     *
     * @return BoatProtos.Board message containing this board
     */
    ...
    /**
     * Modify and return statuscode depending on miss/hit/sunk.
     *
     * This is a board modifying bomb with a bad name so be aware.
     *
     * @param f
     * @return 0 means miss, > 0 means hit and 2 means boat sunk.
     */
    ...
    /**
     * Create board from boardmessage.
     * */
    ...
    /**
     * Convenience container class because java doesn't sport tuples...
     * */
